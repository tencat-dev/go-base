...
- **Database Agent**: Implements repository interfaces with specific DB technology (default: PostgreSQL) using github.com/jackc/pgx for connection and github.com/stephenafamo/bob for ORM, SQL query and migration
